...
app.controller('demoCtrl', function ($scope, $http, registrationService) {
    ...
    //Add New Items
    $scope.save = function () {
        if ($scope.Registration.RegistrationId != "" && $scope.Registration.FirstName != "" && $scope.Registration.LastName != "" && $scope.Registration.Email != "" && $scope.Registration.Login != "" && $scope.Registration.Organization != "" &&
